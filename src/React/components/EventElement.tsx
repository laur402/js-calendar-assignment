...
export function EventElement({
    ...
    const isSmallVersion: boolean =
        elementSettings.isThinHeightVersion ||
        elementSettings.isThinWidthVersion;
    return (
        <div
            ...
            onClick={() => {
                ...
                dispatch(
                    modalInputModify({
                        ...
                        modalEventStart: toISOLocaleString(
                            calendarEvent.eventStart,
                        ),
                        modalEventEnd: toISOLocaleString(
                            calendarEvent.eventEnd,
                        ),
        ...
        >
            <div
                className={
                    CLASSES.WeekView_CalendarEventOverlay_EventBox_EventTitle
                }
            ...
            <div
                className={
                    CLASSES.WeekView_CalendarEventOverlay_EventBox_EventTime
                }
                style={{
