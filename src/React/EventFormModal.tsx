        ...
        >
            ...
            >
                <input
                    ...
                    onChange={e =>
                        dispatch(
                            modalInputModify({ modalEventID: e.target.value }),
                        )
                    }
                />

                <input
                    className={`${CLASSES.EventCreationModal_Body_Form_TitleInput} ${isTitleError ? CLASSES.EventCreationModal_Body_Form_Input_Error : ''}`}
                ...
                >
                    <input
                        className={`${CLASSES.EventCreationModal_Body_Form_EventStartInput} ${isTimeError ? CLASSES.EventCreationModal_Body_Form_Input_Error : ''}`}
                    ...
                    />
                    <input
                        className={`${CLASSES.EventCreationModal_Body_Form_EventEndInput} ${isTimeError ? CLASSES.EventCreationModal_Body_Form_Input_Error : ''}`}
...
function extractFormData(formData: FormData) {
    const eventID: string | undefined = formData
        .get(FORM_IDS.EventID)
        ?.toString();
    ...
    const eventData: EventFormData = {
        ...
        eventDescription:
            formData.get(FORM_IDS.EventDescription)?.toString() ?? '',
    };
    return eventData;
}
